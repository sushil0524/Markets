...
public class TradingApplicationTests {
	...
	public void testGetTrades() throws Exception {
		...
		for (int i = 0; i < expected.size(); i++) {
			Assertions.assertTrue(new ReflectionEquals(expected.get(i), "id").matches(actualRecords.get(i)));
		}
		...
		Assertions.assertTrue(new ReflectionEquals(expectedMap.get("user23_buy_ABX"), "id").matches(actualRecords.get(0)));
